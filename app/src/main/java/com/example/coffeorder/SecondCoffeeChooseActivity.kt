...
class SecondCoffeeChooseActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.second_coffee_choose_activity)
    ...
    private fun checkChooseCoffee() {
        ...
        val image3 = findViewById<ImageView>(R.id.imageView6)
